...
console.log(coursesAndDurationArray.sort((a:ICourse, b:ICourse):number => b.monthDuration - a.monthDuration))
/*-- відфільтрувати , залишивши тільки курси з тривалістю більше 5 місяців*/
console.log(coursesAndDurationArray.filter((value:ICourse):boolean => value.monthDuration > 5))
/*-- за допомоги map перетворити кожен елемент на наступний тип {id,title,monthDuration}*/
console.log(coursesAndDurationArray.map((value:ICourse, index:number):object => {
...
console.log(cards.filter((value:ICard):boolean => value.cardSuit === 'spade' && value.value === 'ace'))
console.log(cards.filter((value:ICard):boolean => value.value === '6'))
console.log(cards.filter((value:ICard):boolean => value.color === Color.red))
console.log(cards.filter((value:ICard):boolean => value.cardSuit === 'diamond'))
console.log(cards.filter((value:ICard):boolean => value.cardSuit === 'clubs' && (parseInt(value.value) >= 9 || !parseInt(value.value) )))
/*
...
console.log(cards.reduce((accum:Acc, card:ICard):Acc => {
...
interface ICourseNew extends ICourse{
    hourDuration:number
    modules:string[]
}
